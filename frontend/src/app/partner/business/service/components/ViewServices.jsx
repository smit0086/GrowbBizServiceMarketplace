    ...
    return (
        <div>
            ...
            {services.length === 0 ?
                ...
                :
                <div>
                    <Button type="button" onClick={() => setRenderAddService(true)}>Add</Button>
                                ...
                                <CardContent>
                                    <div className="grid w-full items-center gap-4">
                                        <div className="flex flex-col space-y-1.5">
                                            <Label htmlFor={`category-${service.serviceId}`} style={{ fontSize: '1rem', fontWeight: 'bold' }}>Price per hour</Label>
                                            <span id={`category-${service.serviceId}`} style={{ fontSize: '0.875rem' }}>{service.servicePrice}</span>
                                        </div>
                                    </div>
                                </CardContent>
